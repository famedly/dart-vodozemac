...
abstract class RustLibApi extends BaseApi {
  ...
  Uint8List crateBindingsAesCtr({required List<int> input, required List<int> key, required List<int> iv});

  Uint8List crateBindingsHmac({required List<int> key, required List<int> input});

  Uint8List crateBindingsPbkdf2({required List<int> passphrase, required List<int> salt, required int iterations});
  ...
  Uint8List crateBindingsVodozemacAccountRemoveOneTimeKey({required VodozemacAccount that, required String publicKey});
  ...
  VodozemacPkMessage crateBindingsVodozemacPkEncryptionEncrypt({
    required VodozemacPkEncryption that,
    required String message,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateBindingsPkSigningFromSecretKeyConstMeta =>
      const TaskConstMeta(debugName: "PkSigning_from_secret_key", argNames: ["key"]);
  ...
  TaskConstMeta get kCrateBindingsPkSigningNewConstMeta =>
      const TaskConstMeta(debugName: "PkSigning_new", argNames: []);
  ...
  VodozemacEd25519PublicKey crateBindingsPkSigningPublicKey({required PkSigning that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_ed_25519_public_key, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsPkSigningPublicKeyConstMeta =>
      const TaskConstMeta(debugName: "PkSigning_public_key", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsPkSigningSecretKeyConstMeta =>
      const TaskConstMeta(debugName: "PkSigning_secret_key", argNames: ["that"]);
  ...
  VodozemacEd25519Signature crateBindingsPkSigningSign({required PkSigning that, required String message}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_ed_25519_signature, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsPkSigningSignConstMeta =>
      const TaskConstMeta(debugName: "PkSigning_sign", argNames: ["that", "message"]);
  ...
  VodozemacEstablishedSas crateBindingsVodozemacSasEstablishSasSecret({
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          var arg0 = cst_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVodozemacSas(
            that,
          );
  ...
  TaskConstMeta get kCrateBindingsVodozemacSasEstablishSasSecretConstMeta =>
      const TaskConstMeta(debugName: "VodozemacSas_establish_sas_secret", argNames: ["that", "otherPublicKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacSasNewConstMeta =>
      const TaskConstMeta(debugName: "VodozemacSas_new", argNames: []);
  ...
  String crateBindingsVodozemacSasPublicKey({required VodozemacSas that}) {
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          var arg0 = cst_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVodozemacSas(
            that,
          );
  ...
  TaskConstMeta get kCrateBindingsVodozemacSasPublicKeyConstMeta =>
      const TaskConstMeta(debugName: "VodozemacSas_public_key", argNames: ["that"]);
  ...
  Uint8List crateBindingsAesCtr({required List<int> input, required List<int> key, required List<int> iv}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_list_prim_u_8_strict, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsAesCtrConstMeta =>
      const TaskConstMeta(debugName: "aes_ctr", argNames: ["input", "key", "iv"]);
  ...
  TaskConstMeta get kCrateBindingsHmacConstMeta => const TaskConstMeta(debugName: "hmac", argNames: ["key", "input"]);
  ...
  TaskConstMeta get kCrateBindingsPbkdf2ConstMeta =>
      const TaskConstMeta(debugName: "pbkdf2", argNames: ["passphrase", "salt", "iterations"]);
  ...
  TaskConstMeta get kCrateBindingsSha256ConstMeta => const TaskConstMeta(debugName: "sha256", argNames: ["input"]);
  ...
  TaskConstMeta get kCrateBindingsSha512ConstMeta => const TaskConstMeta(debugName: "sha512", argNames: ["input"]);
  ...
  VodozemacSession crateBindingsVodozemacAccountCreateOutboundSession({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_session, decodeErrorData: null),
  ...
  VodozemacCurve25519PublicKey crateBindingsVodozemacAccountCurve25519Key({required VodozemacAccount that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_curve_25519_public_key, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountCurve25519KeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_curve25519_key", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountEd25519KeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_ed25519_key", argNames: ["that"]);
  ...
  List<VodozemacOneTimeKey> crateBindingsVodozemacAccountFallbackKey({required VodozemacAccount that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_list_vodozemac_one_time_key, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountFallbackKeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_fallback_key", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountForgetFallbackKeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_forget_fallback_key", argNames: ["that"]);
  ...
  VodozemacAccount crateBindingsVodozemacAccountFromOlmPickleEncrypted({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_account, decodeErrorData: dco_decode_AnyhowException),
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountFromOlmPickleEncryptedConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_from_olm_pickle_encrypted", argNames: ["pickle", "pickleKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountFromPickleEncryptedConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_from_pickle_encrypted", argNames: ["pickle", "pickleKey"]);
  ...
  String? crateBindingsVodozemacAccountGenerateFallbackKey({required VodozemacAccount that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_opt_String, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountGenerateFallbackKeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_generate_fallback_key", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountGenerateOneTimeKeysConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_generate_one_time_keys", argNames: ["that", "count"]);
  ...
  VodozemacIdentityKeys crateBindingsVodozemacAccountIdentityKeys({required VodozemacAccount that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_identity_keys, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountIdentityKeysConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_identity_keys", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountMarkKeysAsPublishedConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_mark_keys_as_published", argNames: ["that"]);
  ...
  BigInt crateBindingsVodozemacAccountMaxNumberOfOneTimeKeys({required VodozemacAccount that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_usize, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountMaxNumberOfOneTimeKeysConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_max_number_of_one_time_keys", argNames: ["that"]);
  ...
  VodozemacAccount crateBindingsVodozemacAccountNew() {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_account, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountNewConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_new", argNames: []);
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountOneTimeKeysConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_one_time_keys", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountPickleEncryptedConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_pickle_encrypted", argNames: ["that", "pickleKey"]);
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          return wire.wire__crate__bindings__vodozemac_account_remove_one_time_key(arg0, arg1);
        },
        codec: DcoCodec(decodeSuccessData: dco_decode_list_prim_u_8_strict, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountRemoveOneTimeKeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_remove_one_time_key", argNames: ["that", "publicKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacAccountSignConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_account_sign", argNames: ["that", "message"]);
  ...
  U8Array32 crateBindingsVodozemacCurve25519PublicKeyAsBytes({required VodozemacCurve25519PublicKey that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_u_8_array_32, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacCurve25519PublicKeyAsBytesConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_curve_25519_public_key_as_bytes", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacCurve25519PublicKeyFromBase64ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_curve_25519_public_key_from_base64", argNames: ["base64Key"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacCurve25519PublicKeyFromSliceConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_curve_25519_public_key_from_slice", argNames: ["bytes"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacCurve25519PublicKeyToBase64ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_curve_25519_public_key_to_base64", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacEd25519PublicKeyAsBytesConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_ed_25519_public_key_as_bytes", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacEd25519PublicKeyFromBase64ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_ed_25519_public_key_from_base64", argNames: ["base64Key"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacEd25519PublicKeyFromSliceConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_ed_25519_public_key_from_slice", argNames: ["bytes"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacEd25519PublicKeyToBase64ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_ed_25519_public_key_to_base64", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacEd25519SignatureFromBase64ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_ed_25519_signature_from_base64", argNames: ["signature"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacEd25519SignatureFromSliceConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_ed_25519_signature_from_slice", argNames: ["bytes"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacEd25519SignatureToBase64ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_ed_25519_signature_to_base64", argNames: ["that"]);
  ...
  U8Array64 crateBindingsVodozemacEd25519SignatureToBytes({required VodozemacEd25519Signature that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_u_8_array_64, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacEd25519SignatureToBytesConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_ed_25519_signature_to_bytes", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacEstablishedSasCalculateMacConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_established_sas_calculate_mac", argNames: ["that", "input", "info"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacEstablishedSasGenerateBytesConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_established_sas_generate_bytes", argNames: ["that", "info", "length"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacGroupSessionEncryptConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_group_session_encrypt", argNames: ["that", "plaintext"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacGroupSessionMessageIndexConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_group_session_message_index", argNames: ["that"]);
  ...
  VodozemacGroupSession crateBindingsVodozemacGroupSessionNew({required VodozemacMegolmSessionConfig config}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_group_session, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacGroupSessionNewConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_group_session_new", argNames: ["config"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacGroupSessionPickleEncryptedConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_group_session_pickle_encrypted", argNames: ["that", "pickleKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacGroupSessionSessionConfigConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_group_session_session_config", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacGroupSessionSessionIdConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_group_session_session_id", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacGroupSessionSessionKeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_group_session_session_key", argNames: ["that"]);
  ...
  VodozemacInboundGroupSession crateBindingsVodozemacGroupSessionToInbound({required VodozemacGroupSession that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_inbound_group_session, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacGroupSessionToInboundConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_group_session_to_inbound", argNames: ["that"]);
  ...
  DecryptResult crateBindingsVodozemacInboundGroupSessionDecrypt({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_decrypt_result, decodeErrorData: dco_decode_AnyhowException),
  ...
  TaskConstMeta get kCrateBindingsVodozemacInboundGroupSessionDecryptConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_inbound_group_session_decrypt", argNames: ["that", "encrypted"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacInboundGroupSessionExportAtConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_inbound_group_session_export_at", argNames: ["that", "index"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacInboundGroupSessionExportAtFirstKnownIndexConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_inbound_group_session_export_at_first_known_index", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacInboundGroupSessionFirstKnownIndexConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_inbound_group_session_first_known_index", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacInboundGroupSessionNewConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_inbound_group_session_new", argNames: ["sessionKey", "config"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacInboundGroupSessionSessionIdConstMeta =>
  ...
  int crateBindingsVodozemacMegolmSessionConfigVersion({required VodozemacMegolmSessionConfig that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_u_8, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacMegolmSessionConfigVersionConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_megolm_session_config_version", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacMegolmSessionConfigVersion1ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_megolm_session_config_version_1", argNames: []);
  ...
  TaskConstMeta get kCrateBindingsVodozemacMegolmSessionConfigVersion2ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_megolm_session_config_version_2", argNames: []);
  ...
  TaskConstMeta get kCrateBindingsVodozemacOlmMessageFromPartsConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_olm_message_from_parts", argNames: ["messageType", "ciphertext"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacOlmMessageMessageConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_olm_message_message", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacOlmSessionConfigVersionConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_olm_session_config_version", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacOlmSessionConfigVersion1ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_olm_session_config_version_1", argNames: []);
  ...
  TaskConstMeta get kCrateBindingsVodozemacOlmSessionConfigVersion2ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_olm_session_config_version_2", argNames: []);
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkDecryptionDecryptConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_decryption_decrypt", argNames: ["that", "message"]);
  ...
  VodozemacPkDecryption crateBindingsVodozemacPkDecryptionFromKey({required U8Array32 secretKey}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_pk_decryption, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkDecryptionFromKeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_decryption_from_key", argNames: ["secretKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkDecryptionFromLibolmPickleConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_decryption_from_libolm_pickle", argNames: ["pickle", "pickleKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkDecryptionNewConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_decryption_new", argNames: []);
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkDecryptionPrivateKeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_decryption_private_key", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkDecryptionPublicKeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_decryption_public_key", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkDecryptionToLibolmPickleConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_decryption_to_libolm_pickle", argNames: ["that", "pickleKey"]);
  ...
  VodozemacPkMessage crateBindingsVodozemacPkEncryptionEncrypt({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_pk_message, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkEncryptionEncryptConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_encryption_encrypt", argNames: ["that", "message"]);
  ...
  VodozemacPkEncryption crateBindingsVodozemacPkEncryptionFromKey({required VodozemacCurve25519PublicKey publicKey}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_pk_encryption, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkEncryptionFromKeyConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_encryption_from_key", argNames: ["publicKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkMessageNewConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_message_new", argNames: ["ciphertext", "mac", "ephemeralKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacPkMessageToBase64ConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_pk_message_to_base64", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacSessionDecryptConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_session_decrypt", argNames: ["that", "message"]);
  ...
  VodozemacOlmMessage crateBindingsVodozemacSessionEncrypt({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_olm_message, decodeErrorData: null),
  ...
  TaskConstMeta get kCrateBindingsVodozemacSessionEncryptConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_session_encrypt", argNames: ["that", "plaintext"]);
  ...
  VodozemacSession crateBindingsVodozemacSessionFromOlmPickleEncrypted({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        codec: DcoCodec(decodeSuccessData: dco_decode_vodozemac_session, decodeErrorData: dco_decode_AnyhowException),
  ...
  TaskConstMeta get kCrateBindingsVodozemacSessionFromOlmPickleEncryptedConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_session_from_olm_pickle_encrypted", argNames: ["pickle", "pickleKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacSessionFromPickleEncryptedConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_session_from_pickle_encrypted", argNames: ["pickle", "pickleKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacSessionHasReceivedMessageConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_session_has_received_message", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacSessionPickleEncryptedConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_session_pickle_encrypted", argNames: ["that", "pickleKey"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacSessionSessionConfigConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_session_session_config", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateBindingsVodozemacSessionSessionIdConstMeta =>
      const TaskConstMeta(debugName: "vodozemac_session_session_id", argNames: ["that"]);
  ...
  DecryptResult dco_decode_decrypt_result(dynamic raw) {
    ...
    return DecryptResult(field0: dco_decode_String(arr[0]), field1: dco_decode_u_32(arr[1]));
  }
  ...
  (String, String, String) dco_decode_record_string_string_string(dynamic raw) {
    ...
    return (dco_decode_String(arr[0]), dco_decode_String(arr[1]), dco_decode_String(arr[2]));
  }
  ...
  VodozemacAccount dco_decode_vodozemac_account(dynamic raw) {
    ...
    return VodozemacAccount.raw(account: dco_decode_RustOpaque_stdsyncRwLockAccount(arr[0]));
  }
  ...
  VodozemacCurve25519PublicKey dco_decode_vodozemac_curve_25519_public_key(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacCurve25519PublicKey(key: dco_decode_RustOpaque_Curve25519PublicKey(arr[0]));
  }
  ...
  VodozemacEd25519PublicKey dco_decode_vodozemac_ed_25519_public_key(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacEd25519PublicKey(key: dco_decode_RustOpaque_Ed25519PublicKey(arr[0]));
  }
  ...
  VodozemacEd25519Signature dco_decode_vodozemac_ed_25519_signature(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacEd25519Signature(signature: dco_decode_RustOpaque_Ed25519Signature(arr[0]));
  }
  ...
  VodozemacEstablishedSas dco_decode_vodozemac_established_sas(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacEstablishedSas(establishedSas: dco_decode_RustOpaque_EstablishedSas(arr[0]));
  }
  ...
  VodozemacGroupSession dco_decode_vodozemac_group_session(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacGroupSession.raw(session: dco_decode_RustOpaque_RwLockGroupSession(arr[0]));
  }
  ...
  VodozemacInboundGroupSession dco_decode_vodozemac_inbound_group_session(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacInboundGroupSession.raw(session: dco_decode_RustOpaque_RwLockInboundGroupSession(arr[0]));
  }
  ...
  VodozemacMegolmSessionConfig dco_decode_vodozemac_megolm_session_config(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacMegolmSessionConfig(config: dco_decode_RustOpaque_MegolmSessionConfig(arr[0]));
  }
  ...
  VodozemacOlmMessage dco_decode_vodozemac_olm_message(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacOlmMessage(msg: dco_decode_RustOpaque_OlmMessage(arr[0]));
  }
  ...
  VodozemacOlmSessionConfig dco_decode_vodozemac_olm_session_config(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacOlmSessionConfig(config: dco_decode_RustOpaque_OlmSessionConfig(arr[0]));
  }
  ...
  VodozemacPkDecryption dco_decode_vodozemac_pk_decryption(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacPkDecryption.raw(pkDecryption: dco_decode_RustOpaque_PkDecryption(arr[0]));
  }
  ...
  VodozemacPkEncryption dco_decode_vodozemac_pk_encryption(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacPkEncryption(pkEncryption: dco_decode_RustOpaque_PkEncryption(arr[0]));
  }
  ...
  VodozemacSession dco_decode_vodozemac_session(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacSession(session: dco_decode_RustOpaque_RwLockSession(arr[0]));
  }
...
class PkSigningImpl extends RustOpaque implements PkSigning {
  ...
  VodozemacEd25519PublicKey publicKey() => RustLib.instance.api.crateBindingsPkSigningPublicKey(that: this);

  String secretKey() => RustLib.instance.api.crateBindingsPkSigningSecretKey(that: this);
...
class VodozemacSasImpl extends RustOpaque implements VodozemacSas {
  ...
  String publicKey() => RustLib.instance.api.crateBindingsVodozemacSasPublicKey(that: this);
}
